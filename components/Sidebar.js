...
export default function Sidebar() {
  ...
  return (
    <div
      className={`sm:none duration-200 fixed !z-50 flex min-h-full flex-col bg-[#BCCEEF] pb-10 shadow-2xl shadow-white/5 transition-all dark:!bg-navy-800 dark:text-white md:!z-50 lg:!z-50 xl:!z-0 
